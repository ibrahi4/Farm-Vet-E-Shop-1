    ...
    <div className="relative min-h-screen text-white px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="absolute bottom-4 right-4 flex flex-wrap gap-2">
        <button
          ...
          className={`flex items-center gap-2 rounded-xl px-4 py-2 text-sm font-semibold backdrop-blur-md border border-white/20 transition ${isFavorite
        ...
        <button
          ...
          disabled={inCart}
          className={`flex items-center gap-2 rounded-xl px-4 py-2 text-sm font-semibold backdrop-blur-md border border-white/20 transition ${inCart
