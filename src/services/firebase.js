...
export const firebaseConfig = {
  apiKey: "AIzaSyCrbPfqqig6fAJ3ZwJkjO0RbBWudodLsL8",
...
export async function uploadImage(file, folderPath = "uploads/") {
  ...
  try {
    ...
    throw new Error(
      "فشل الحصول على رمز المصادقة. يرجى تسجيل الخروج والدخول مرة أخرى."
    );
  }
  ...
  try {
    ...
    if (
      ...
      throw new Error(
        "ليس لديك صلاحية لرفع الملفات. يرجى التحقق من تسجيل الدخول."
      );
      ...
      throw new Error(
        "خطأ CORS: يرجى إعداد Firebase Storage Rules. راجع ملف FIREBASE_RULES_QUICK_SETUP.md للتعليمات السريعة."
      );
    }
